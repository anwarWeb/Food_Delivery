            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/90.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Sweets</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/74.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Fast food</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/72.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Drinks</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/81.jpg" alt="" />
        ...
        <div class="container all">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img src="img/1.png" class="rounded-circle" alt="Cinque Terre" width="304" height="236"><br> 
                        <a class="btn1 hvr-hover" href="#"><p>Book your table</p></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img src="img/2.jpg" class="rounded-circle" alt="Cinque Terre" width="304" height="236"><br> 
                        <a class="btn1 hvr-hover" href="#"><p>Call Now</p></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img src="img/7.png" class="rounded-circle" alt="Cinque Terre" width="304" height="236"><br> 
...
</html>>&nbsp;&nbsp;&nbsp;Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="about.html">&nbsp;&nbsp;&nbsp;About Us</a>
                </li>
