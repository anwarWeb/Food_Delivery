		...
		<div class="row">
			...
			@foreach ($foods as $food)
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="{{asset('frontend/images/img_1.jpg') }}" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="{{$food->image? asset('storage/'.$food->image->url):'//placehold.it/100'}}" alt="Image" class="img-responsive">
							
						</figure>
						<div class="fh5co-text">
							<h2>{{$food->title}}</h2>
							<p>{{$food->description}}</p>
							<p><span class="price cursive-font">&#8360; {{$food->price}}</span></p>
						</div>
					</a>
				</div>
			@endforeach
